...
export const VERSION_NOTES: VersionNote[] = [
  ...
  },
  {
    ...
    features: [
      'NEW: Edit split payment names and amounts',
      'NEW: Delete individual split payments',
      'NEW: Edit icon buttons on each split',
      'IMPROVED: Full control over split payment details',
    ],
    bugFixes: [],
    breaking: [],
  },
